<template>
  <!--:disabled是用来接收父级的值的，用来做点击事件处理的。起css样式的是class里的disabled-->
  <button
      :class="[
      `sweet-button--${type}`,
      `sweet-button--${size}`,
...
.sweet-button--default:hover,
.sweet-button--default:focus {
  color: #669fff;
...
.sweet-button--primary:hover,
.sweet-button--primary:focus {
  color: white;
...
.sweet-button--success:hover,
.sweet-button--success:focus {
  color: white;
...
.sweet-button--info:hover,
.sweet-button--info:focus {
  color: white;
...
.sweet-button--warning:hover,
.sweet-button--warning:focus {
  color: white;
...
.sweet-button--danger:hover,
.sweet-button--danger:focus {
  color: white;
